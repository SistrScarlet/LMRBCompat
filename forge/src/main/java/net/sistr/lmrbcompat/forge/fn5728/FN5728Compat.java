...
public class FN5728Compat {
    ...
    public void init() {
        register("shooter", ModeType
                ...
                .addItemMatcher(ItemMatchers.item(mod_IFN_FN5728Guns.item_fiveseven.get()), ItemMatcher.Priority.HIGHER)
                .addItemMatcher(ItemMatchers.item(mod_IFN_FN5728Guns.item_p90.get()), ItemMatcher.Priority.HIGHER)
                .build());
